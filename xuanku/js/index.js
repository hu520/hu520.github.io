...
window.onload = function() {
    ...
    function(down) {
        ...
        if (scrollT >= 2700) {
            ...
            tomiddle.style.transform = 'rotate(720deg)';
            silde.style.opacity = 1;
            toleft.style.left = '890px';
            toleft.style.top = '0';
            toleft.style.transform = 'rotate(720deg)';
            toright.style.right = '890px';
            toright.style.top = '0';
            toright.style.transform = 'rotate(720deg)'
        };
        if (scrollT < 2700) {
    ...
    for (var i = 0; i < data.length; i++) {
        html += '<li><a href="">' + '<img src="' + data[i].img + '">' + '<span class="overlay">' + '</span></a></li>'
    };
    lists.html(html);
